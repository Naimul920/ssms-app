        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="{{$course->image}}" alt="" class="h-250"/>
                        <div class="card-body">
                            <h5>{{$course->title}}</h5>
                            <p>Course Fee : {{$course->fee}} TK</p>
                            <hr/>
                            <a href="{{route('course.detail',['id'=>$course->id])}}" class="btn btn-outline-success">Read More</a>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <section class="">
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="{{asset('/')}}website/img/member2.png" alt="" class="h-250"/>
                        <div class="card-body">
                            <h5>Mr. Hrodoy Khan</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="{{asset('/')}}website/img/member1.png" alt="" class="h-250"/>
                        <div class="card-body">
                            <h5>Mr. Hrodoy Khan</h5>
                            <p>Web Development Specialist</p>
                            <hr/>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="{{asset('/')}}website/img/member3.png" alt="" class="h-250"/>
                        <div class="card-body">
                            <h5>Mr. Hrodoy Khan</h5>
                            <p>Web Development Specialist</p>
                            <hr/>
